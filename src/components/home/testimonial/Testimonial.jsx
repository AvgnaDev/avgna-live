      ...
      <div className="bg-white py-10">
        <div className="max-w-maxWidth mx-auto">
          <div className="text-center relative mb-12">
            ...
            <p className="text-xl xs:text-2xl px-3 relative">
              Relish some kind words from few of our esteemed clients
            </p>
          </div>
          <div className="flex flex-wrap justify-center sm:justify-center gap-5 px-4 xs:px-0 h-full">
            <div className="w-[300px] xs:w-[260px] group rounded relative overflow-hidden bg-gray-100">
              <img className="w-full h-full" src={remedi360} alt="remedi360" />
              <div className="w-full h-full transition-all flex flex-col justify-center p-2 absolute top-0 group-hover:right-0 -right-[100%] bg-white/90 backdrop-blur rounded">
